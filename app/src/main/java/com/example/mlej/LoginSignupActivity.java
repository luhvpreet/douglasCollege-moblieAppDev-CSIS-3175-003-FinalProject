...
public class LoginSignupActivity extends AppCompatActivity {
    ...
    void initData(){
        ...
        db.addAppointment(6,1,1,"Mar 22, 10:00am","ok","ok");
        db.addAppointment(7,1,2,"Mar 22, 2:00pm","ok","ok");
        db.addAppointment(8,1,3,"Mar 22, 5:00pm","ok","ok");
        db.addAppointment(9,1,4,"Mar 23, 10:00am","ok","ok");
        db.addAppointment(10,1,5,"Mar 23, 2:00pm","ok","ok");
        ...
        db.addAppointment(21,2,16,"Mar 27, 10:00am","ok","ok");
        db.addAppointment(22,2,17,"Mar 27, 2:00pm","ok","ok");
        db.addAppointment(23,2,18,"Mar 27, 5:00pm","ok","ok");
        db.addAppointment(24,2,19,"Mar 28, 10:00am","ok","ok");
        db.addAppointment(25,2,20,"Mar 28, 2:00pm","ok","ok");
        db.addAppointment(26,3,21,"Mar 28, 5:00pm","ok","ok");
        db.addAppointment(27,3,22,"Mar 29, 10:00am","ok","ok");
        db.addAppointment(28,3,23,"Mar 29, 2:00pm","ok","ok");
        db.addAppointment(29,3,24,"Mar 29, 5:00pm","ok","ok");
        db.addAppointment(30,3,25,"Mar 30, 10:00am","ok","ok");
        db.addAppointment(31,4,26,"Mar 30, 2:00pm","ok","ok");
        db.addAppointment(32,4,27,"Mar 30, 5:00pm","ok","ok");
        db.addAppointment(33,4,28,"Mar 31, 10:00am","ok","ok");
        db.addAppointment(34,4,29,"Mar 31, 2:00pm","ok","ok");
        db.addAppointment(35,4,30,"Mar 31, 5:00pm","ok","ok");
        db.addAppointment(36,5,31,"Apr 29, 10:00am","ok","ok");
        db.addAppointment(37,5,32,"Apr 29, 2:00pm","ok","ok");
        db.addAppointment(38,5,33,"Apr 29, 5:00pm","ok","ok");
        db.addAppointment(39,5,34,"Apr 30, 10:00am","ok","ok");
        db.addAppointment(40,5,35,"Apr 30, 2:00pm","ok","ok");
        db.addAppointment(41,5,36,"Apr 30, 5:00pm","ok","ok");
        db.addAppointment(42,5,37,"May 31, 10:00am","ok","ok");
        db.addAppointment(43,5,38,"May 31, 2:00pm","ok","ok");
