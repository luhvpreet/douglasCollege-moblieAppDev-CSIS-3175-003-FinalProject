...
public class LoginSignupActivity extends AppCompatActivity {
    ...
    void initData(){
        ...
        db.addAppointment(44,1,1,"2023-04-27 10:00",0);
        db.addAppointment(45,1,2,"2023-04-28 14:00",0);
        db.addAppointment(46,1,3,"2023-04-29 17:00",0);
        db.addAppointment(47,1,4,"2023-04-30 10:30",1);
        db.addAppointment(48,1,5,"2023-05-1 13:30",1);
        db.addAppointment(49,1,6,"2023-05-2 19:30",1);
        db.addAppointment(50,1,7,"2023-05-3 10:30",1);
        db.addAppointment(51,1,8,"2023-05-4 14:15",0);
        db.addAppointment(52,1,9,"2023-05-5 17:15",0);
        db.addAppointment(53,1,10,"2023-05-6 10:15",1);
        db.addAppointment(54,1,11,"2023-05-7 13:45",1);
        db.addAppointment(55,1,12,"2023-05-8 19:45",0);
        db.addAppointment(56,2,13,"2023-05-9 10:00",0);
        db.addAppointment(57,2,14,"2023-05-10 14:00",1);
        db.addAppointment(58,2,15,"2023-05-11 17:00",0);
        db.addAppointment(59,2,16,"2023-05-12 10:30",1);
        db.addAppointment(60,2,17,"2023-05-13 13:30",0);
        ...
        db.addAppointmentServices(39,10);
        db.addAppointmentServices(40,7);
        db.addAppointmentServices(41,1);
        db.addAppointmentServices(42,7);
        db.addAppointmentServices(43,6);
        db.addAppointmentServices(44,6);
        db.addAppointmentServices(44,10);
        db.addAppointmentServices(44,4);
        db.addAppointmentServices(45,5);
        db.addAppointmentServices(45,1);
        db.addAppointmentServices(46,10);
        db.addAppointmentServices(46,7);
        db.addAppointmentServices(47,8);
        db.addAppointmentServices(47,5);
        db.addAppointmentServices(48,10);
        db.addAppointmentServices(48,1);
        db.addAppointmentServices(49,7);
        db.addAppointmentServices(49,8);
        db.addAppointmentServices(50,1);
        db.addAppointmentServices(50,1);
        db.addAppointmentServices(51,1);
        db.addAppointmentServices(51,1);
        db.addAppointmentServices(52,1);
        db.addAppointmentServices(52,1);
        db.addAppointmentServices(53,1);
        db.addAppointmentServices(53,1);
        db.addAppointmentServices(54,1);
        db.addAppointmentServices(54,1);
        db.addAppointmentServices(54,1);
        db.addAppointmentServices(55,1);
        db.addAppointmentServices(55,1);
        db.addAppointmentServices(55,1);
        db.addAppointmentServices(56,1);
        db.addAppointmentServices(56,1);
        db.addAppointmentServices(56,1);
        db.addAppointmentServices(57,1);
        db.addAppointmentServices(57,1);
        db.addAppointmentServices(57,1);
        db.addAppointmentServices(58,1);
        db.addAppointmentServices(58,1);
        db.addAppointmentServices(58,1);
        db.addAppointmentServices(59,1);
        db.addAppointmentServices(59,1);
        db.addAppointmentServices(59,1);
        db.addAppointmentServices(60,1);
        db.addAppointmentServices(60,1);
        db.addAppointmentServices(60,1);
